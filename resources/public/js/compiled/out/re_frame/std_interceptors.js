...
var vec__30917_30920 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_30921 = cljs.core.nth.call(null,vec__30917_30920,(0),null);
var only_after_30922 = cljs.core.nth.call(null,vec__30917_30920,(1),null);
var db_changed_QMARK__30923 = (cljs.core.some_QMARK_.call(null,only_before_30921)) || (cljs.core.some_QMARK_.call(null,only_after_30922));
if(db_changed_QMARK__30923){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for: ",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before: ",only_before_30921);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after : ",only_after_30922);
...
var map__30930 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__30930__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__30930__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__30938 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__30938__$1;
var event = cljs.core.get.call(null,map__30938__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__27082__auto___30941 = arguments.length;
var i__27083__auto___30942 = (0);
while(true){
if((i__27083__auto___30942 < len__27082__auto___30941)){
args__27089__auto__.push((arguments[i__27083__auto___30942]));

var G__30943 = (i__27083__auto___30942 + (1));
i__27083__auto___30942 = G__30943;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__27090__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq30940){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq30940));
});
...
var args__27089__auto__ = [];
var len__27082__auto___30949 = arguments.length;
var i__27083__auto___30950 = (0);
while(true){
if((i__27083__auto___30950 < len__27082__auto___30949)){
args__27089__auto__.push((arguments[i__27083__auto___30950]));

var G__30951 = (i__27083__auto___30950 + (1));
i__27083__auto___30950 = G__30951;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__27090__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__30944_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__30945_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__30945_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq30946){
var G__30947 = cljs.core.first.call(null,seq30946);
var seq30946__$1 = cljs.core.next.call(null,seq30946);
var G__30948 = cljs.core.first.call(null,seq30946__$1);
var seq30946__$2 = cljs.core.next.call(null,seq30946__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__30947,G__30948,seq30946__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1480126461392