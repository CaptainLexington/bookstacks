...
var args28743 = [];
var len__26645__auto___28746 = arguments.length;
var i__26646__auto___28747 = (0);
while(true){
if((i__26646__auto___28747 < len__26645__auto___28746)){
args28743.push((arguments[i__26646__auto___28747]));

var G__28748 = (i__26646__auto___28747 + (1));
i__26646__auto___28747 = G__28748;
continue;
} else {
}
break;
...
var base_style__$1 = (cljs.core.truth_((function (){var and__25558__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__25558__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__25558__auto__)){
...
if(cljs.core.truth_((function (){var and__25558__auto__ = required_QMARK_;
if(cljs.core.truth_(and__25558__auto__)){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__28753){
...
var args = map__28756__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__28756__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__28756__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__28756__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__28756__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__28756__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__28756__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__28756__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__28756__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__28756__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__28756__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__28756__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__28756,map__28756__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__28750_SHARP_){
return item_renderer.call(null,p1__28750_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__28756,map__28756__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__28756,map__28756__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__28751_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__28751_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__28756,map__28756__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__28756,map__28756__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__28752_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__28752_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__28756,map__28756__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__26645__auto___28765 = arguments.length;
var i__26646__auto___28766 = (0);
while(true){
if((i__26646__auto___28766 < len__26645__auto___28765)){
args__26652__auto__.push((arguments[i__26646__auto___28766]));

var G__28767 = (i__26646__auto___28766 + (1));
i__26646__auto___28766 = G__28767;
continue;
} else {
}
break;
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__26653__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__28759){
...
return ((function (map__28760,map__28760__$1,args){
return (function() { 
var G__28768__delegate = function (p__28762){
var map__28763 = p__28762;
var map__28763__$1 = ((((!((map__28763 == null)))?((((map__28763.cljs$lang$protocol_mask$partition0$ & (64))) || (map__28763.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__28763):map__28763);
var args__$1 = map__28763__$1;
...
while (G__28769__i < G__28769__a.length) {G__28769__a[G__28769__i] = arguments[G__28769__i + 0]; ++G__28769__i;}
  p__28762 = new cljs.core.IndexedSeq(G__28769__a,0);
} 
return G__28768__delegate.call(this,p__28762);};
G__28768.cljs$lang$maxFixedArity = 0;
G__28768.cljs$lang$applyTo = (function (arglist__28770){
var p__28762 = cljs.core.seq(arglist__28770);
return G__28768__delegate(p__28762);
});
G__28768.cljs$core$IFn$_invoke$arity$variadic = G__28768__delegate;
return G__28768;
})()
;
;})(map__28760,map__28760__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq28758){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq28758));
});


//# sourceMappingURL=selection_list.js.map?rel=1476657525520