...
var args25927 = [];
var len__23653__auto___25930 = arguments.length;
var i__23654__auto___25931 = (0);
while(true){
if((i__23654__auto___25931 < len__23653__auto___25930)){
args25927.push((arguments[i__23654__auto___25931]));

var G__25932 = (i__23654__auto___25931 + (1));
i__23654__auto___25931 = G__25932;
continue;
} else {
}
break;
...
var base_style__$1 = (cljs.core.truth_((function (){var and__22566__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__22566__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__22566__auto__)){
...
if(cljs.core.truth_((function (){var and__22566__auto__ = required_QMARK_;
if(cljs.core.truth_(and__22566__auto__)){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__25937){
var map__25940 = p__25937;
...
var args = map__25940__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__25940__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__25940__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__25940__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__25940__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__25940__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__25940__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__25940__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__25940__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__25940__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__25940__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__25940__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__25940,map__25940__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__25934_SHARP_){
return item_renderer.call(null,p1__25934_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__25940,map__25940__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__25940,map__25940__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__25935_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__25935_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__25940,map__25940__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__25940,map__25940__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__25936_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__25936_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__25940,map__25940__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__23653__auto___25949 = arguments.length;
var i__23654__auto___25950 = (0);
while(true){
if((i__23654__auto___25950 < len__23653__auto___25949)){
args__23660__auto__.push((arguments[i__23654__auto___25950]));

var G__25951 = (i__23654__auto___25950 + (1));
i__23654__auto___25950 = G__25951;
continue;
} else {
}
break;
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__23661__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__25943){
...
var args = map__25944__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__25944,map__25944__$1,args){
return (function() { 
var G__25952__delegate = function (p__25946){
...
while (G__25953__i < G__25953__a.length) {G__25953__a[G__25953__i] = arguments[G__25953__i + 0]; ++G__25953__i;}
  p__25946 = new cljs.core.IndexedSeq(G__25953__a,0);
} 
return G__25952__delegate.call(this,p__25946);};
G__25952.cljs$lang$maxFixedArity = 0;
G__25952.cljs$lang$applyTo = (function (arglist__25954){
var p__25946 = cljs.core.seq(arglist__25954);
return G__25952__delegate(p__25946);
});
G__25952.cljs$core$IFn$_invoke$arity$variadic = G__25952__delegate;
return G__25952;
})()
;
;})(map__25944,map__25944__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq25942){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq25942));
});


//# sourceMappingURL=selection_list.js.map?rel=1473455230997