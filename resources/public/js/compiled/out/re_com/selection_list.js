...
var args30904 = [];
var len__26651__auto___30907 = arguments.length;
var i__26652__auto___30908 = (0);
while(true){
if((i__26652__auto___30908 < len__26651__auto___30907)){
args30904.push((arguments[i__26652__auto___30908]));

var G__30909 = (i__26652__auto___30908 + (1));
i__26652__auto___30908 = G__30909;
continue;
} else {
}
break;
...
var base_style__$1 = (cljs.core.truth_((function (){var and__25564__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__25564__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__25564__auto__)){
...
if(cljs.core.truth_((function (){var and__25564__auto__ = required_QMARK_;
if(cljs.core.truth_(and__25564__auto__)){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__30914){
...
var args = map__30917__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__30917__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__30917__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__30917__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__30917__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__30917__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__30917__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__30917__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__30917__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__30917__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__30917__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__30917__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__30917,map__30917__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__30911_SHARP_){
return item_renderer.call(null,p1__30911_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__30917,map__30917__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__30917,map__30917__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__30912_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__30912_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__30917,map__30917__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__30917,map__30917__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__30913_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__30913_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__30917,map__30917__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__26651__auto___30926 = arguments.length;
var i__26652__auto___30927 = (0);
while(true){
if((i__26652__auto___30927 < len__26651__auto___30926)){
args__26658__auto__.push((arguments[i__26652__auto___30927]));

var G__30928 = (i__26652__auto___30927 + (1));
i__26652__auto___30927 = G__30928;
continue;
} else {
}
break;
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__26659__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__30920){
...
var args = map__30921__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__30921,map__30921__$1,args){
return (function() { 
var G__30929__delegate = function (p__30923){
...
while (G__30930__i < G__30930__a.length) {G__30930__a[G__30930__i] = arguments[G__30930__i + 0]; ++G__30930__i;}
  p__30923 = new cljs.core.IndexedSeq(G__30930__a,0);
} 
return G__30929__delegate.call(this,p__30923);};
G__30929.cljs$lang$maxFixedArity = 0;
G__30929.cljs$lang$applyTo = (function (arglist__30931){
var p__30923 = cljs.core.seq(arglist__30931);
return G__30929__delegate(p__30923);
});
G__30929.cljs$core$IFn$_invoke$arity$variadic = G__30929__delegate;
return G__30929;
})()
;
;})(map__30921,map__30921__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq30919){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq30919));
});


//# sourceMappingURL=selection_list.js.map?rel=1480029279041