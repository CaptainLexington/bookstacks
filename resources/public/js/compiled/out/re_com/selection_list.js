...
var args25616 = [];
var len__23653__auto___25619 = arguments.length;
var i__23654__auto___25620 = (0);
while(true){
if((i__23654__auto___25620 < len__23653__auto___25619)){
args25616.push((arguments[i__23654__auto___25620]));

var G__25621 = (i__23654__auto___25620 + (1));
i__23654__auto___25620 = G__25621;
continue;
} else {
}
break;
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__25626){
var map__25629 = p__25626;
...
var args = map__25629__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__25629__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__25629__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__25629__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__25629__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__25629__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__25629__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__25629__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__25629__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__25629__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__25629__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__25629__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__25629,map__25629__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__25623_SHARP_){
return item_renderer.call(null,p1__25623_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__25629,map__25629__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__25629,map__25629__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__25624_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__25624_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__25629,map__25629__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__25629,map__25629__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__25625_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__25625_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__25629,map__25629__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__23653__auto___25638 = arguments.length;
var i__23654__auto___25639 = (0);
while(true){
if((i__23654__auto___25639 < len__23653__auto___25638)){
args__23660__auto__.push((arguments[i__23654__auto___25639]));

var G__25640 = (i__23654__auto___25639 + (1));
i__23654__auto___25639 = G__25640;
continue;
} else {
}
break;
...
re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__25632){
...
var args = map__25633__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__25633,map__25633__$1,args){
return (function() { 
var G__25641__delegate = function (p__25635){
...
while (G__25642__i < G__25642__a.length) {G__25642__a[G__25642__i] = arguments[G__25642__i + 0]; ++G__25642__i;}
  p__25635 = new cljs.core.IndexedSeq(G__25642__a,0);
} 
return G__25641__delegate.call(this,p__25635);};
G__25641.cljs$lang$maxFixedArity = 0;
G__25641.cljs$lang$applyTo = (function (arglist__25643){
var p__25635 = cljs.core.seq(arglist__25643);
return G__25641__delegate(p__25635);
});
G__25641.cljs$core$IFn$_invoke$arity$variadic = G__25641__delegate;
return G__25641;
})()
;
;})(map__25633,map__25633__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq25631){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq25631));
});


//# sourceMappingURL=selection_list.js.map?rel=1474484605398