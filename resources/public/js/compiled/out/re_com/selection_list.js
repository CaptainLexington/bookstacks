...
var args30647 = [];
var len__27082__auto___30650 = arguments.length;
var i__27083__auto___30651 = (0);
while(true){
if((i__27083__auto___30651 < len__27082__auto___30650)){
args30647.push((arguments[i__27083__auto___30651]));

var G__30652 = (i__27083__auto___30651 + (1));
i__27083__auto___30651 = G__30652;
continue;
} else {
}
break;
...
var base_style__$1 = (cljs.core.truth_((function (){var and__25962__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__25962__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__25962__auto__)){
...
if(cljs.core.truth_((function (){var and__25962__auto__ = required_QMARK_;
if(cljs.core.truth_(and__25962__auto__)){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__30657){
...
var disabled_QMARK_ = cljs.core.get.call(null,map__30660__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__30660__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__30660__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__30660__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__30660__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__30660__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__30660__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__30660__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__30660__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__30660__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__30660__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__30660,map__30660__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__30654_SHARP_){
return item_renderer.call(null,p1__30654_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__30660,map__30660__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__30660,map__30660__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__30655_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__30655_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__30660,map__30660__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__30660,map__30660__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__30656_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__30656_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__30660,map__30660__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__27082__auto___30669 = arguments.length;
var i__27083__auto___30670 = (0);
while(true){
if((i__27083__auto___30670 < len__27082__auto___30669)){
args__27089__auto__.push((arguments[i__27083__auto___30670]));

var G__30671 = (i__27083__auto___30670 + (1));
i__27083__auto___30670 = G__30671;
continue;
} else {
}
break;
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__27090__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__30663){
...
var args = map__30664__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__30664,map__30664__$1,args){
return (function() { 
var G__30672__delegate = function (p__30666){
...
while (G__30673__i < G__30673__a.length) {G__30673__a[G__30673__i] = arguments[G__30673__i + 0]; ++G__30673__i;}
  p__30666 = new cljs.core.IndexedSeq(G__30673__a,0);
} 
return G__30672__delegate.call(this,p__30666);};
G__30672.cljs$lang$maxFixedArity = 0;
G__30672.cljs$lang$applyTo = (function (arglist__30674){
var p__30666 = cljs.core.seq(arglist__30674);
return G__30672__delegate(p__30666);
});
G__30672.cljs$core$IFn$_invoke$arity$variadic = G__30672__delegate;
return G__30672;
})()
;
;})(map__30664,map__30664__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq30662){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq30662));
});


//# sourceMappingURL=selection_list.js.map?rel=1480126460434