...
var len__27082__auto___29749 = arguments.length;
var i__27083__auto___29750 = (0);
while(true){
if((i__27083__auto___29750 < len__27082__auto___29749)){
args__27089__auto__.push((arguments[i__27083__auto___29750]));

var G__29751 = (i__27083__auto___29750 + (1));
i__27083__auto___29750 = G__29751;
continue;
} else {
}
break;
...
return re_com.text.label.cljs$core$IFn$_invoke$arity$variadic(argseq__27090__auto__);
});

re_com.text.label.cljs$core$IFn$_invoke$arity$variadic = (function (p__29746){
...
var args = map__29747__$1;
var label = cljs.core.get.call(null,map__29747__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var on_click = cljs.core.get.call(null,map__29747__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543));
var width = cljs.core.get.call(null,map__29747__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var class$ = cljs.core.get.call(null,map__29747__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var style = cljs.core.get.call(null,map__29747__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var attr = cljs.core.get.call(null,map__29747__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
...
var args__27089__auto__ = [];
var len__27082__auto___29756 = arguments.length;
var i__27083__auto___29757 = (0);
while(true){
if((i__27083__auto___29757 < len__27082__auto___29756)){
args__27089__auto__.push((arguments[i__27083__auto___29757]));

var G__29758 = (i__27083__auto___29757 + (1));
i__27083__auto___29757 = G__29758;
continue;
} else {
}
break;
...
var argseq__27090__auto__ = ((((0) < args__27089__auto__.length))?(new cljs.core.IndexedSeq(args__27089__auto__.slice((0)),(0),null)):null);
return re_com.text.title.cljs$core$IFn$_invoke$arity$variadic(argseq__27090__auto__);
});

re_com.text.title.cljs$core$IFn$_invoke$arity$variadic = (function (p__29753){
...
var args = map__29754__$1;
var label = cljs.core.get.call(null,map__29754__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var level = cljs.core.get.call(null,map__29754__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var underline_QMARK_ = cljs.core.get.call(null,map__29754__$1,new cljs.core.Keyword(null,"underline?","underline?",-1123247603));
var margin_top = cljs.core.get.call(null,map__29754__$1,new cljs.core.Keyword(null,"margin-top","margin-top",392161226),"0.6em");
var margin_bottom = cljs.core.get.call(null,map__29754__$1,new cljs.core.Keyword(null,"margin-bottom","margin-bottom",388334941),"0.3em");
var class$ = cljs.core.get.call(null,map__29754__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var style = cljs.core.get.call(null,map__29754__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var attr = cljs.core.get.call(null,map__29754__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
...
re_com.text.title.cljs$lang$applyTo = (function (seq29752){
return re_com.text.title.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq29752));
});
...
var args__27089__auto__ = [];
var len__27082__auto___29763 = arguments.length;
var i__27083__auto___29764 = (0);
while(true){
if((i__27083__auto___29764 < len__27082__auto___29763)){
args__27089__auto__.push((arguments[i__27083__auto___29764]));

var G__29765 = (i__27083__auto___29764 + (1));
i__27083__auto___29764 = G__29765;
continue;
} else {
}
break;
...
var argseq__27090__auto__ = ((((0) < args__27089__auto__.length))?(new cljs.core.IndexedSeq(args__27089__auto__.slice((0)),(0),null)):null);
return re_com.text.p.cljs$core$IFn$_invoke$arity$variadic(argseq__27090__auto__);
});

re_com.text.p.cljs$core$IFn$_invoke$arity$variadic = (function (children){
var child1 = cljs.core.first.call(null,children);
var vec__29760 = ((cljs.core.map_QMARK_.call(null,child1))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [child1,cljs.core.rest.call(null,children)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.PersistentArrayMap.EMPTY,children], null));
var m = cljs.core.nth.call(null,vec__29760,(0),null);
var children__$1 = cljs.core.nth.call(null,vec__29760,(1),null);
...
re_com.text.p.cljs$lang$applyTo = (function (seq29759){
return re_com.text.p.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq29759));
});


//# sourceMappingURL=text.js.map?rel=1480126458105