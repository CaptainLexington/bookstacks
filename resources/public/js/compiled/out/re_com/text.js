...
var len__26645__auto___27845 = arguments.length;
var i__26646__auto___27846 = (0);
while(true){
if((i__26646__auto___27846 < len__26645__auto___27845)){
args__26652__auto__.push((arguments[i__26646__auto___27846]));

var G__27847 = (i__26646__auto___27846 + (1));
i__26646__auto___27846 = G__27847;
continue;
} else {
}
break;
...
return re_com.text.label.cljs$core$IFn$_invoke$arity$variadic(argseq__26653__auto__);
});

re_com.text.label.cljs$core$IFn$_invoke$arity$variadic = (function (p__27842){
...
var args = map__27843__$1;
var label = cljs.core.get.call(null,map__27843__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var on_click = cljs.core.get.call(null,map__27843__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543));
var width = cljs.core.get.call(null,map__27843__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var class$ = cljs.core.get.call(null,map__27843__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var style = cljs.core.get.call(null,map__27843__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var attr = cljs.core.get.call(null,map__27843__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
...
var args__26652__auto__ = [];
var len__26645__auto___27852 = arguments.length;
var i__26646__auto___27853 = (0);
while(true){
if((i__26646__auto___27853 < len__26645__auto___27852)){
args__26652__auto__.push((arguments[i__26646__auto___27853]));

var G__27854 = (i__26646__auto___27853 + (1));
i__26646__auto___27853 = G__27854;
continue;
} else {
}
break;
...
var argseq__26653__auto__ = ((((0) < args__26652__auto__.length))?(new cljs.core.IndexedSeq(args__26652__auto__.slice((0)),(0),null)):null);
return re_com.text.title.cljs$core$IFn$_invoke$arity$variadic(argseq__26653__auto__);
});

re_com.text.title.cljs$core$IFn$_invoke$arity$variadic = (function (p__27849){
...
var args = map__27850__$1;
var label = cljs.core.get.call(null,map__27850__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var level = cljs.core.get.call(null,map__27850__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var underline_QMARK_ = cljs.core.get.call(null,map__27850__$1,new cljs.core.Keyword(null,"underline?","underline?",-1123247603));
var margin_top = cljs.core.get.call(null,map__27850__$1,new cljs.core.Keyword(null,"margin-top","margin-top",392161226),"0.6em");
var margin_bottom = cljs.core.get.call(null,map__27850__$1,new cljs.core.Keyword(null,"margin-bottom","margin-bottom",388334941),"0.3em");
var class$ = cljs.core.get.call(null,map__27850__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var style = cljs.core.get.call(null,map__27850__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var attr = cljs.core.get.call(null,map__27850__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
...
re_com.text.title.cljs$lang$applyTo = (function (seq27848){
return re_com.text.title.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq27848));
});
...
var args__26652__auto__ = [];
var len__26645__auto___27859 = arguments.length;
var i__26646__auto___27860 = (0);
while(true){
if((i__26646__auto___27860 < len__26645__auto___27859)){
args__26652__auto__.push((arguments[i__26646__auto___27860]));

var G__27861 = (i__26646__auto___27860 + (1));
i__26646__auto___27860 = G__27861;
continue;
} else {
}
break;
...
var argseq__26653__auto__ = ((((0) < args__26652__auto__.length))?(new cljs.core.IndexedSeq(args__26652__auto__.slice((0)),(0),null)):null);
return re_com.text.p.cljs$core$IFn$_invoke$arity$variadic(argseq__26653__auto__);
});

re_com.text.p.cljs$core$IFn$_invoke$arity$variadic = (function (children){
var child1 = cljs.core.first.call(null,children);
var vec__27856 = ((cljs.core.map_QMARK_.call(null,child1))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [child1,cljs.core.rest.call(null,children)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.PersistentArrayMap.EMPTY,children], null));
var m = cljs.core.nth.call(null,vec__27856,(0),null);
var children__$1 = cljs.core.nth.call(null,vec__27856,(1),null);
...
re_com.text.p.cljs$lang$applyTo = (function (seq27855){
return re_com.text.p.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq27855));
});


//# sourceMappingURL=text.js.map?rel=1476657523877