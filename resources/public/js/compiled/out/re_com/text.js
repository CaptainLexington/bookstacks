...
var len__26651__auto___30006 = arguments.length;
var i__26652__auto___30007 = (0);
while(true){
if((i__26652__auto___30007 < len__26651__auto___30006)){
args__26658__auto__.push((arguments[i__26652__auto___30007]));

var G__30008 = (i__26652__auto___30007 + (1));
i__26652__auto___30007 = G__30008;
continue;
} else {
}
break;
...
return re_com.text.label.cljs$core$IFn$_invoke$arity$variadic(argseq__26659__auto__);
});

re_com.text.label.cljs$core$IFn$_invoke$arity$variadic = (function (p__30003){
...
var args = map__30004__$1;
var label = cljs.core.get.call(null,map__30004__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var on_click = cljs.core.get.call(null,map__30004__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543));
var width = cljs.core.get.call(null,map__30004__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var class$ = cljs.core.get.call(null,map__30004__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var style = cljs.core.get.call(null,map__30004__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var attr = cljs.core.get.call(null,map__30004__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
...
var args__26658__auto__ = [];
var len__26651__auto___30013 = arguments.length;
var i__26652__auto___30014 = (0);
while(true){
if((i__26652__auto___30014 < len__26651__auto___30013)){
args__26658__auto__.push((arguments[i__26652__auto___30014]));

var G__30015 = (i__26652__auto___30014 + (1));
i__26652__auto___30014 = G__30015;
continue;
} else {
}
break;
...
var argseq__26659__auto__ = ((((0) < args__26658__auto__.length))?(new cljs.core.IndexedSeq(args__26658__auto__.slice((0)),(0),null)):null);
return re_com.text.title.cljs$core$IFn$_invoke$arity$variadic(argseq__26659__auto__);
});

re_com.text.title.cljs$core$IFn$_invoke$arity$variadic = (function (p__30010){
...
var args = map__30011__$1;
var label = cljs.core.get.call(null,map__30011__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var level = cljs.core.get.call(null,map__30011__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var underline_QMARK_ = cljs.core.get.call(null,map__30011__$1,new cljs.core.Keyword(null,"underline?","underline?",-1123247603));
var margin_top = cljs.core.get.call(null,map__30011__$1,new cljs.core.Keyword(null,"margin-top","margin-top",392161226),"0.6em");
var margin_bottom = cljs.core.get.call(null,map__30011__$1,new cljs.core.Keyword(null,"margin-bottom","margin-bottom",388334941),"0.3em");
var class$ = cljs.core.get.call(null,map__30011__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var style = cljs.core.get.call(null,map__30011__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var attr = cljs.core.get.call(null,map__30011__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
...
re_com.text.title.cljs$lang$applyTo = (function (seq30009){
return re_com.text.title.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq30009));
});
...
var args__26658__auto__ = [];
var len__26651__auto___30020 = arguments.length;
var i__26652__auto___30021 = (0);
while(true){
if((i__26652__auto___30021 < len__26651__auto___30020)){
args__26658__auto__.push((arguments[i__26652__auto___30021]));

var G__30022 = (i__26652__auto___30021 + (1));
i__26652__auto___30021 = G__30022;
continue;
} else {
}
break;
...
var argseq__26659__auto__ = ((((0) < args__26658__auto__.length))?(new cljs.core.IndexedSeq(args__26658__auto__.slice((0)),(0),null)):null);
return re_com.text.p.cljs$core$IFn$_invoke$arity$variadic(argseq__26659__auto__);
});

re_com.text.p.cljs$core$IFn$_invoke$arity$variadic = (function (children){
var child1 = cljs.core.first.call(null,children);
var vec__30017 = ((cljs.core.map_QMARK_.call(null,child1))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [child1,cljs.core.rest.call(null,children)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.PersistentArrayMap.EMPTY,children], null));
var m = cljs.core.nth.call(null,vec__30017,(0),null);
var children__$1 = cljs.core.nth.call(null,vec__30017,(1),null);
...
re_com.text.p.cljs$lang$applyTo = (function (seq30016){
return re_com.text.p.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq30016));
});


//# sourceMappingURL=text.js.map?rel=1480029276522