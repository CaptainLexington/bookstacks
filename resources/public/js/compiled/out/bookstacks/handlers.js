...
var len__27082__auto___29112 = arguments.length;
var i__27083__auto___29113 = (0);
while(true){
if((i__27083__auto___29113 < len__27082__auto___29112)){
args__27089__auto__.push((arguments[i__27083__auto___29113]));

var G__29114 = (i__27083__auto___29113 + (1));
i__27083__auto___29113 = G__29114;
continue;
} else {
}
break;
...
return cljs.core.reduce.call(null,(function (r,p__29108){
var vec__29109 = p__29108;
var k = cljs.core.nth.call(null,vec__29109,(0),null);
var v = cljs.core.nth.call(null,vec__29109,(1),null);
...
bookstacks.handlers.update_values.cljs$lang$applyTo = (function (seq29105){
...
return bookstacks.handlers.update_values.cljs$core$IFn$_invoke$arity$variadic(G__29106,G__29107,seq29105__$2);
});
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"load-user","load-user",-1622997493),(function (db,p__29115){
var vec__29116 = p__29115;
var _ = cljs.core.nth.call(null,vec__29116,(0),null);
var user = cljs.core.nth.call(null,vec__29116,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"add-bookstack","add-bookstack",776640780),(function (db,p__29124){
var vec__29125 = p__29124;
var _ = cljs.core.nth.call(null,vec__29125,(0),null);
var new_title = cljs.core.nth.call(null,vec__29125,(1),null);
var new_list = cljs.core.nth.call(null,vec__29125,(2),null);
var books = cljs.core.mapv.call(null,((function (vec__29125,_,new_title,new_list){
return (function (p1__29119_SHARP_){
return bookstacks.handlers.book.call(null,p1__29119_SHARP_);
});})(vec__29125,_,new_title,new_list))
,clojure.string.split.call(null,new_list,/\n/));
return bookstacks.handlers.update_user.call(null,cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"books","books",-2005362272),cljs.core.reduce.call(null,((function (books,vec__29125,_,new_title,new_list){
return (function (p1__29120_SHARP_,p2__29121_SHARP_){
return cljs.core.assoc.call(null,p1__29120_SHARP_,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p2__29121_SHARP_),p2__29121_SHARP_);
});})(books,vec__29125,_,new_title,new_list))
,new cljs.core.Keyword(null,"books","books",-2005362272).cljs$core$IFn$_invoke$arity$1(db),cljs.core.map_indexed.call(null,((function (books,vec__29125,_,new_title,new_list){
return (function (p1__29123_SHARP_,p2__29122_SHARP_){
return bookstacks.handlers.add_book_to_stack.call(null,new_title,p2__29122_SHARP_,p1__29123_SHARP_);
});})(books,vec__29125,_,new_title,new_list))
,books))));
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"edit-bookstack-name","edit-bookstack-name",863376763),(function (db,p__29128){
var vec__29129 = p__29128;
var _ = cljs.core.nth.call(null,vec__29129,(0),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"editing-stack-name?","editing-stack-name?",-1878594953),true);
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"update-bookstack-name","update-bookstack-name",1046186781),(function (db,p__29134){
var vec__29135 = p__29134;
var _ = cljs.core.nth.call(null,vec__29135,(0),null);
var stack = cljs.core.nth.call(null,vec__29135,(1),null);
var new_name = cljs.core.nth.call(null,vec__29135,(2),null);
window.location = [cljs.core.str("/#/stacks/"),cljs.core.str(clojure.string.replace.call(null,new_name," ","_"))].join('');

return cljs.core.reduce.call(null,((function (vec__29135,_,stack,new_name){
return (function (p1__29132_SHARP_,p2__29133_SHARP_){
return cljs.core.assoc_in.call(null,p1__29132_SHARP_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"books","books",-2005362272),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p2__29133_SHARP_),new cljs.core.Keyword(null,"stacks","stacks",-456633410)], null),clojure.set.rename_keys.call(null,new cljs.core.Keyword(null,"stacks","stacks",-456633410).cljs$core$IFn$_invoke$arity$1(p2__29133_SHARP_),cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(stack),new_name], true, false)));
});})(vec__29135,_,stack,new_name))
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"toggle-book-selected","toggle-book-selected",-2069806980),(function (db,p__29138){
var vec__29139 = p__29138;
var _ = cljs.core.nth.call(null,vec__29139,(0),null);
var book = cljs.core.nth.call(null,vec__29139,(1),null);
return cljs.core.assoc_in.call(null,db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"books","books",-2005362272),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(book)], null),(cljs.core.truth_(new cljs.core.Keyword(null,"selected?","selected?",-742502788).cljs$core$IFn$_invoke$arity$1(book))?cljs.core.dissoc.call(null,book,new cljs.core.Keyword(null,"selected?","selected?",-742502788)):cljs.core.assoc.call(null,book,new cljs.core.Keyword(null,"selected?","selected?",-742502788),true)));
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"delete-bookstack","delete-bookstack",-162070907),(function (db,p__29143){
var vec__29144 = p__29143;
var _ = cljs.core.nth.call(null,vec__29144,(0),null);
var stack = cljs.core.nth.call(null,vec__29144,(1),null);
window.location = "/#/stacks/In_Progress";

return bookstacks.handlers.update_user.call(null,cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"books","books",-2005362272),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,((function (vec__29144,_,stack){
return (function (p1__29142_SHARP_){
return cljs.core.empty_QMARK_.call(null,new cljs.core.Keyword(null,"stacks","stacks",-456633410).cljs$core$IFn$_invoke$arity$1(cljs.core.second.call(null,p1__29142_SHARP_)));
});})(vec__29144,_,stack))
,bookstacks.handlers.update_values.call(null,new cljs.core.Keyword(null,"books","books",-2005362272).cljs$core$IFn$_invoke$arity$1(db),((function (vec__29144,_,stack){
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"add-book","add-book",-1937507385),(function (db,p__29147){
var vec__29148 = p__29147;
var _ = cljs.core.nth.call(null,vec__29148,(0),null);
var stack = cljs.core.nth.call(null,vec__29148,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"update-read-status","update-read-status",-1675555937),(function (db,p__29151){
var vec__29152 = p__29151;
var _ = cljs.core.nth.call(null,vec__29152,(0),null);
var status = cljs.core.nth.call(null,vec__29152,(1),null);
var book = cljs.core.nth.call(null,vec__29152,(2),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"update-search-term","update-search-term",-1725569553),(function (db,p__29155){
var vec__29156 = p__29155;
var _ = cljs.core.nth.call(null,vec__29156,(0),null);
var search_term = cljs.core.nth.call(null,vec__29156,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"search-term","search-term",356193544),search_term);
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"select-stack","select-stack",-919506772),(function (db,p__29159){
var vec__29160 = p__29159;
var _ = cljs.core.nth.call(null,vec__29160,(0),null);
var stack_name = cljs.core.nth.call(null,vec__29160,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"edit-book-title","edit-book-title",-234853508),(function (db,p__29163){
var vec__29164 = p__29163;
var _ = cljs.core.nth.call(null,vec__29164,(0),null);
var book = cljs.core.nth.call(null,vec__29164,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"update-book-title","update-book-title",1073440360),(function (db,p__29167){
var vec__29168 = p__29167;
var _ = cljs.core.nth.call(null,vec__29168,(0),null);
var title = cljs.core.nth.call(null,vec__29168,(1),null);
var book = cljs.core.nth.call(null,vec__29168,(2),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"update-book-index","update-book-index",-1769768117),(function (db,p__29173){
var vec__29174 = p__29173;
var _ = cljs.core.nth.call(null,vec__29174,(0),null);
var book = cljs.core.nth.call(null,vec__29174,(1),null);
var stack = cljs.core.nth.call(null,vec__29174,(2),null);
var old_index = cljs.core.nth.call(null,vec__29174,(3),null);
var new_index = cljs.core.nth.call(null,vec__29174,(4),null);
return cljs.core.reduce.call(null,((function (vec__29174,_,book,stack,old_index,new_index){
return (function (p1__29172_SHARP_,p2__29171_SHARP_){
var index = new cljs.core.Keyword(null,"index","index",-1531685915).cljs$core$IFn$_invoke$arity$1(p2__29171_SHARP_);
var updated_index = bookstacks.handlers.update_index.call(null,old_index,new_index,index);
return cljs.core.assoc_in.call(null,p1__29172_SHARP_,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"books","books",-2005362272),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p2__29171_SHARP_),new cljs.core.Keyword(null,"stacks","stacks",-456633410),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(stack)], null),updated_index);
});})(vec__29174,_,book,stack,old_index,new_index))
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"remove-book-from-stack","remove-book-from-stack",-900505670),(function (db,p__29177){
var vec__29178 = p__29177;
var _ = cljs.core.nth.call(null,vec__29178,(0),null);
var stack = cljs.core.nth.call(null,vec__29178,(1),null);
var book = cljs.core.nth.call(null,vec__29178,(2),null);
...
//# sourceMappingURL=handlers.js.map?rel=1482729982926