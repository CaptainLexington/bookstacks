...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"set-active-panel","set-active-panel",-965871124),(function (db,p__48729){
var vec__48730 = p__48729;
var _ = cljs.core.nth.call(null,vec__48730,(0),null);
var active_panel = cljs.core.nth.call(null,vec__48730,(1),null);
...
var len__26651__auto___48740 = arguments.length;
var i__26652__auto___48741 = (0);
while(true){
if((i__26652__auto___48741 < len__26651__auto___48740)){
args__26658__auto__.push((arguments[i__26652__auto___48741]));

var G__48742 = (i__26652__auto___48741 + (1));
i__26652__auto___48741 = G__48742;
continue;
} else {
}
break;
...
return cljs.core.reduce.call(null,(function (r,p__48736){
var vec__48737 = p__48736;
var k = cljs.core.nth.call(null,vec__48737,(0),null);
var v = cljs.core.nth.call(null,vec__48737,(1),null);
...
bookstacks.handlers.update_values.cljs$lang$applyTo = (function (seq48733){
var G__48734 = cljs.core.first.call(null,seq48733);
var seq48733__$1 = cljs.core.next.call(null,seq48733);
var G__48735 = cljs.core.first.call(null,seq48733__$1);
var seq48733__$2 = cljs.core.next.call(null,seq48733__$1);
return bookstacks.handlers.update_values.cljs$core$IFn$_invoke$arity$variadic(G__48734,G__48735,seq48733__$2);
});
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"load-user","load-user",-1622997493),(function (db,p__48743){
var vec__48744 = p__48743;
var _ = cljs.core.nth.call(null,vec__48744,(0),null);
var user = cljs.core.nth.call(null,vec__48744,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"add-bookstack","add-bookstack",776640780),(function (db,p__48752){
var vec__48753 = p__48752;
var _ = cljs.core.nth.call(null,vec__48753,(0),null);
var new_title = cljs.core.nth.call(null,vec__48753,(1),null);
var new_list = cljs.core.nth.call(null,vec__48753,(2),null);
var books = cljs.core.mapv.call(null,((function (vec__48753,_,new_title,new_list){
return (function (p1__48747_SHARP_){
return bookstacks.handlers.book.call(null,p1__48747_SHARP_);
});})(vec__48753,_,new_title,new_list))
,clojure.string.split.call(null,new_list,/\n/));
return bookstacks.handlers.update_user.call(null,cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"books","books",-2005362272),cljs.core.reduce.call(null,((function (books,vec__48753,_,new_title,new_list){
return (function (p1__48748_SHARP_,p2__48749_SHARP_){
return cljs.core.assoc.call(null,p1__48748_SHARP_,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p2__48749_SHARP_),p2__48749_SHARP_);
});})(books,vec__48753,_,new_title,new_list))
,new cljs.core.Keyword(null,"books","books",-2005362272).cljs$core$IFn$_invoke$arity$1(db),cljs.core.map_indexed.call(null,((function (books,vec__48753,_,new_title,new_list){
return (function (p1__48751_SHARP_,p2__48750_SHARP_){
return bookstacks.handlers.add_book_to_stack.call(null,new_title,p2__48750_SHARP_,p1__48751_SHARP_);
});})(books,vec__48753,_,new_title,new_list))
,books))));
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"delete-bookstack","delete-bookstack",-162070907),(function (db,p__48757){
var vec__48758 = p__48757;
var _ = cljs.core.nth.call(null,vec__48758,(0),null);
var stack = cljs.core.nth.call(null,vec__48758,(1),null);
window.location = "/#/stacks/In_Progress";

return bookstacks.handlers.update_user.call(null,cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"books","books",-2005362272),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,((function (vec__48758,_,stack){
return (function (p1__48756_SHARP_){
return cljs.core.empty_QMARK_.call(null,new cljs.core.Keyword(null,"stacks","stacks",-456633410).cljs$core$IFn$_invoke$arity$1(cljs.core.second.call(null,p1__48756_SHARP_)));
});})(vec__48758,_,stack))
,bookstacks.handlers.update_values.call(null,new cljs.core.Keyword(null,"books","books",-2005362272).cljs$core$IFn$_invoke$arity$1(db),((function (vec__48758,_,stack){
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"add-book","add-book",-1937507385),(function (db,p__48761){
var vec__48762 = p__48761;
var _ = cljs.core.nth.call(null,vec__48762,(0),null);
var stack = cljs.core.nth.call(null,vec__48762,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"update-read-status","update-read-status",-1675555937),(function (db,p__48765){
var vec__48766 = p__48765;
var _ = cljs.core.nth.call(null,vec__48766,(0),null);
var status = cljs.core.nth.call(null,vec__48766,(1),null);
var book = cljs.core.nth.call(null,vec__48766,(2),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"update-search-term","update-search-term",-1725569553),(function (db,p__48769){
var vec__48770 = p__48769;
var _ = cljs.core.nth.call(null,vec__48770,(0),null);
var search_term = cljs.core.nth.call(null,vec__48770,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"search-term","search-term",356193544),search_term);
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"select-stack","select-stack",-919506772),(function (db,p__48773){
var vec__48774 = p__48773;
var _ = cljs.core.nth.call(null,vec__48774,(0),null);
var stack_name = cljs.core.nth.call(null,vec__48774,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"edit-book-title","edit-book-title",-234853508),(function (db,p__48777){
var vec__48778 = p__48777;
var _ = cljs.core.nth.call(null,vec__48778,(0),null);
var book = cljs.core.nth.call(null,vec__48778,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"update-book-title","update-book-title",1073440360),(function (db,p__48781){
var vec__48782 = p__48781;
var _ = cljs.core.nth.call(null,vec__48782,(0),null);
var title = cljs.core.nth.call(null,vec__48782,(1),null);
var book = cljs.core.nth.call(null,vec__48782,(2),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"update-book-index","update-book-index",-1769768117),(function (db,p__48787){
var vec__48788 = p__48787;
var _ = cljs.core.nth.call(null,vec__48788,(0),null);
var book = cljs.core.nth.call(null,vec__48788,(1),null);
var stack = cljs.core.nth.call(null,vec__48788,(2),null);
var old_index = cljs.core.nth.call(null,vec__48788,(3),null);
var new_index = cljs.core.nth.call(null,vec__48788,(4),null);
return cljs.core.reduce.call(null,((function (vec__48788,_,book,stack,old_index,new_index){
return (function (p1__48786_SHARP_,p2__48785_SHARP_){
var index = new cljs.core.Keyword(null,"index","index",-1531685915).cljs$core$IFn$_invoke$arity$1(p2__48785_SHARP_);
var updated_index = bookstacks.handlers.update_index.call(null,old_index,new_index,index);
return cljs.core.assoc_in.call(null,p1__48786_SHARP_,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"books","books",-2005362272),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p2__48785_SHARP_),new cljs.core.Keyword(null,"stacks","stacks",-456633410),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(stack)], null),updated_index);
});})(vec__48788,_,book,stack,old_index,new_index))
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"remove-book-from-stack","remove-book-from-stack",-900505670),(function (db,p__48791){
var vec__48792 = p__48791;
var _ = cljs.core.nth.call(null,vec__48792,(0),null);
var stack = cljs.core.nth.call(null,vec__48792,(1),null);
var book = cljs.core.nth.call(null,vec__48792,(2),null);
...
//# sourceMappingURL=handlers.js.map?rel=1480124369020