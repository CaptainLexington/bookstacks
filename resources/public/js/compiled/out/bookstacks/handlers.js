...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"set-active-panel","set-active-panel",-965871124),(function (db,p__30817){
var vec__30818 = p__30817;
var _ = cljs.core.nth.call(null,vec__30818,(0),null);
var active_panel = cljs.core.nth.call(null,vec__30818,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"load-user","load-user",-1622997493),(function (db,p__30821){
var vec__30822 = p__30821;
var _ = cljs.core.nth.call(null,vec__30822,(0),null);
var user = cljs.core.nth.call(null,vec__30822,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"add-bookstack","add-bookstack",776640780),(function (db,p__30825){
var vec__30826 = p__30825;
var _ = cljs.core.nth.call(null,vec__30826,(0),null);
var new_title = cljs.core.nth.call(null,vec__30826,(1),null);
var new_list = cljs.core.nth.call(null,vec__30826,(2),null);
return bookstacks.handlers.update.call(null,cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"books","books",-2005362272),cljs.core.vec.call(null,cljs.core.concat.call(null,new cljs.core.Keyword(null,"books","books",-2005362272).cljs$core$IFn$_invoke$arity$1(db),cljs.core.map_indexed.call(null,((function (vec__30826,_,new_title,new_list){
...
});})(vec__30826,_,new_title,new_list))
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"update-read-status","update-read-status",-1675555937),(function (db,p__30829){
var vec__30830 = p__30829;
var _ = cljs.core.nth.call(null,vec__30830,(0),null);
var status = cljs.core.nth.call(null,vec__30830,(1),null);
var book = cljs.core.nth.call(null,vec__30830,(2),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"update-search-term","update-search-term",-1725569553),(function (db,p__30833){
var vec__30834 = p__30833;
var _ = cljs.core.nth.call(null,vec__30834,(0),null);
var search_term = cljs.core.nth.call(null,vec__30834,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"search-term","search-term",356193544),search_term);
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"select-stack","select-stack",-919506772),(function (db,p__30837){
var vec__30838 = p__30837;
var _ = cljs.core.nth.call(null,vec__30838,(0),null);
var stack_name = cljs.core.nth.call(null,vec__30838,(1),null);
...
//# sourceMappingURL=handlers.js.map?rel=1476664090026