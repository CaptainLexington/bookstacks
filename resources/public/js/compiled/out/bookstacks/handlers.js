...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"set-active-panel","set-active-panel",-965871124),(function (db,p__43636){
var vec__43637 = p__43636;
var _ = cljs.core.nth.call(null,vec__43637,(0),null);
var active_panel = cljs.core.nth.call(null,vec__43637,(1),null);
...
var len__26651__auto___43647 = arguments.length;
var i__26652__auto___43648 = (0);
while(true){
if((i__26652__auto___43648 < len__26651__auto___43647)){
args__26658__auto__.push((arguments[i__26652__auto___43648]));

var G__43649 = (i__26652__auto___43648 + (1));
i__26652__auto___43648 = G__43649;
continue;
} else {
}
break;
...
return cljs.core.reduce.call(null,(function (r,p__43643){
var vec__43644 = p__43643;
var k = cljs.core.nth.call(null,vec__43644,(0),null);
var v = cljs.core.nth.call(null,vec__43644,(1),null);
...
bookstacks.handlers.update_values.cljs$lang$applyTo = (function (seq43640){
var G__43641 = cljs.core.first.call(null,seq43640);
var seq43640__$1 = cljs.core.next.call(null,seq43640);
var G__43642 = cljs.core.first.call(null,seq43640__$1);
var seq43640__$2 = cljs.core.next.call(null,seq43640__$1);
return bookstacks.handlers.update_values.cljs$core$IFn$_invoke$arity$variadic(G__43641,G__43642,seq43640__$2);
});
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"load-user","load-user",-1622997493),(function (db,p__43650){
var vec__43651 = p__43650;
var _ = cljs.core.nth.call(null,vec__43651,(0),null);
var user = cljs.core.nth.call(null,vec__43651,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"add-bookstack","add-bookstack",776640780),(function (db,p__43659){
var vec__43660 = p__43659;
var _ = cljs.core.nth.call(null,vec__43660,(0),null);
var new_title = cljs.core.nth.call(null,vec__43660,(1),null);
var new_list = cljs.core.nth.call(null,vec__43660,(2),null);
var books = cljs.core.mapv.call(null,((function (vec__43660,_,new_title,new_list){
return (function (p1__43654_SHARP_){
return bookstacks.handlers.book.call(null,p1__43654_SHARP_);
});})(vec__43660,_,new_title,new_list))
,clojure.string.split.call(null,new_list,/\n/));
return bookstacks.handlers.update_user.call(null,cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"books","books",-2005362272),cljs.core.reduce.call(null,((function (books,vec__43660,_,new_title,new_list){
return (function (p1__43655_SHARP_,p2__43656_SHARP_){
return cljs.core.assoc.call(null,p1__43655_SHARP_,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p2__43656_SHARP_),p2__43656_SHARP_);
});})(books,vec__43660,_,new_title,new_list))
,new cljs.core.Keyword(null,"books","books",-2005362272).cljs$core$IFn$_invoke$arity$1(db),cljs.core.map_indexed.call(null,((function (books,vec__43660,_,new_title,new_list){
return (function (p1__43658_SHARP_,p2__43657_SHARP_){
return bookstacks.handlers.add_book_to_stack.call(null,new_title,p2__43657_SHARP_,p1__43658_SHARP_);
});})(books,vec__43660,_,new_title,new_list))
,books))));
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"delete-bookstack","delete-bookstack",-162070907),(function (db,p__43664){
var vec__43665 = p__43664;
var _ = cljs.core.nth.call(null,vec__43665,(0),null);
var stack = cljs.core.nth.call(null,vec__43665,(1),null);
window.location = "/#/stacks/In_Progress";

return bookstacks.handlers.update_user.call(null,cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"books","books",-2005362272),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,((function (vec__43665,_,stack){
return (function (p1__43663_SHARP_){
return cljs.core.empty_QMARK_.call(null,new cljs.core.Keyword(null,"stacks","stacks",-456633410).cljs$core$IFn$_invoke$arity$1(cljs.core.second.call(null,p1__43663_SHARP_)));
});})(vec__43665,_,stack))
,bookstacks.handlers.update_values.call(null,new cljs.core.Keyword(null,"books","books",-2005362272).cljs$core$IFn$_invoke$arity$1(db),((function (vec__43665,_,stack){
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"add-book","add-book",-1937507385),(function (db,p__43668){
var vec__43669 = p__43668;
var _ = cljs.core.nth.call(null,vec__43669,(0),null);
var stack_name = cljs.core.nth.call(null,vec__43669,(1),null);
var new_book = bookstacks.handlers.book.call(null,"");
return cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"books","books",-2005362272),bookstacks.handlers.add_book.call(null,new cljs.core.Keyword(null,"books","books",-2005362272).cljs$core$IFn$_invoke$arity$1(db),cljs.core.assoc.call(null,new_book,new cljs.core.Keyword(null,"editing?","editing?",1646440800),true)));
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"update-read-status","update-read-status",-1675555937),(function (db,p__43672){
var vec__43673 = p__43672;
var _ = cljs.core.nth.call(null,vec__43673,(0),null);
var status = cljs.core.nth.call(null,vec__43673,(1),null);
var book = cljs.core.nth.call(null,vec__43673,(2),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"update-search-term","update-search-term",-1725569553),(function (db,p__43676){
var vec__43677 = p__43676;
var _ = cljs.core.nth.call(null,vec__43677,(0),null);
var search_term = cljs.core.nth.call(null,vec__43677,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"search-term","search-term",356193544),search_term);
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"select-stack","select-stack",-919506772),(function (db,p__43680){
var vec__43681 = p__43680;
var _ = cljs.core.nth.call(null,vec__43681,(0),null);
var stack_name = cljs.core.nth.call(null,vec__43681,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"edit-book-title","edit-book-title",-234853508),(function (db,p__43684){
var vec__43685 = p__43684;
var _ = cljs.core.nth.call(null,vec__43685,(0),null);
var book = cljs.core.nth.call(null,vec__43685,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"update-book-title","update-book-title",1073440360),(function (db,p__43688){
var vec__43689 = p__43688;
var _ = cljs.core.nth.call(null,vec__43689,(0),null);
var title = cljs.core.nth.call(null,vec__43689,(1),null);
var book = cljs.core.nth.call(null,vec__43689,(2),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"remove-book-from-stack","remove-book-from-stack",-900505670),(function (db,p__43692){
var vec__43693 = p__43692;
var _ = cljs.core.nth.call(null,vec__43693,(0),null);
var stack = cljs.core.nth.call(null,vec__43693,(1),null);
var book = cljs.core.nth.call(null,vec__43693,(2),null);
...
//# sourceMappingURL=handlers.js.map?rel=1480050914988