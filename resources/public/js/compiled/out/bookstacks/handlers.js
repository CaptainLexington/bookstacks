...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"set-active-panel","set-active-panel",-965871124),(function (db,p__29198){
var vec__29199 = p__29198;
var _ = cljs.core.nth.call(null,vec__29199,(0),null);
var active_panel = cljs.core.nth.call(null,vec__29199,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"load-user","load-user",-1622997493),(function (db,p__29202){
var vec__29203 = p__29202;
var _ = cljs.core.nth.call(null,vec__29203,(0),null);
var user = cljs.core.nth.call(null,vec__29203,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"add-bookstack","add-bookstack",776640780),(function (db,p__29206){
var vec__29207 = p__29206;
var _ = cljs.core.nth.call(null,vec__29207,(0),null);
var new_title = cljs.core.nth.call(null,vec__29207,(1),null);
var new_list = cljs.core.nth.call(null,vec__29207,(2),null);
return bookstacks.handlers.update.call(null,cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"books","books",-2005362272),cljs.core.vec.call(null,cljs.core.concat.call(null,new cljs.core.Keyword(null,"books","books",-2005362272).cljs$core$IFn$_invoke$arity$1(db),cljs.core.map_indexed.call(null,((function (vec__29207,_,new_title,new_list){
...
});})(vec__29207,_,new_title,new_list))
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"delete-bookstack","delete-bookstack",-162070907),(function (db,p__29211){
var vec__29212 = p__29211;
var _ = cljs.core.nth.call(null,vec__29212,(0),null);
var stack = cljs.core.nth.call(null,vec__29212,(1),null);
window.location = "/#/stacks/In_Progress";

return bookstacks.handlers.update.call(null,cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"books","books",-2005362272),cljs.core.vec.call(null,cljs.core.remove.call(null,((function (vec__29212,_,stack){
return (function (p1__29210_SHARP_){
return cljs.core.empty_QMARK_.call(null,new cljs.core.Keyword(null,"stacks","stacks",-456633410).cljs$core$IFn$_invoke$arity$1(p1__29210_SHARP_));
});})(vec__29212,_,stack))
,cljs.core.map.call(null,((function (vec__29212,_,stack){
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"add-book","add-book",-1937507385),(function (db,p__29215){
var vec__29216 = p__29215;
var _ = cljs.core.nth.call(null,vec__29216,(0),null);
var stack = cljs.core.nth.call(null,vec__29216,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"update-read-status","update-read-status",-1675555937),(function (db,p__29219){
var vec__29220 = p__29219;
var _ = cljs.core.nth.call(null,vec__29220,(0),null);
var status = cljs.core.nth.call(null,vec__29220,(1),null);
var book = cljs.core.nth.call(null,vec__29220,(2),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"update-search-term","update-search-term",-1725569553),(function (db,p__29223){
var vec__29224 = p__29223;
var _ = cljs.core.nth.call(null,vec__29224,(0),null);
var search_term = cljs.core.nth.call(null,vec__29224,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"search-term","search-term",356193544),search_term);
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"select-stack","select-stack",-919506772),(function (db,p__29227){
var vec__29228 = p__29227;
var _ = cljs.core.nth.call(null,vec__29228,(0),null);
var stack_name = cljs.core.nth.call(null,vec__29228,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"edit-book-title","edit-book-title",-234853508),(function (db,p__29231){
var vec__29232 = p__29231;
var _ = cljs.core.nth.call(null,vec__29232,(0),null);
var book = cljs.core.nth.call(null,vec__29232,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"update-book-title","update-book-title",1073440360),(function (db,p__29235){
var vec__29236 = p__29235;
var _ = cljs.core.nth.call(null,vec__29236,(0),null);
var title = cljs.core.nth.call(null,vec__29236,(1),null);
var book = cljs.core.nth.call(null,vec__29236,(2),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"delete-book","delete-book",460673736),(function (db,p__29240){
var vec__29241 = p__29240;
var _ = cljs.core.nth.call(null,vec__29241,(0),null);
var book = cljs.core.nth.call(null,vec__29241,(1),null);
return bookstacks.handlers.update.call(null,cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"books","books",-2005362272),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.remove.call(null,((function (vec__29241,_,book){
return (function (p1__29239_SHARP_){
return cljs.core._EQ_.call(null,p1__29239_SHARP_,cljs.core.dissoc.call(null,book,new cljs.core.Keyword(null,"index","index",-1531685915)));
});})(vec__29241,_,book))
,new cljs.core.Keyword(null,"books","books",-2005362272).cljs$core$IFn$_invoke$arity$1(db)))));
}));

//# sourceMappingURL=handlers.js.map?rel=1476911511829