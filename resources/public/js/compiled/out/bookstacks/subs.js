...
return clojure.set.select.call(null,(function (p1__29127_SHARP_){
return clojure.string.includes_QMARK_.call(null,clojure.string.lower_case.call(null,p1__29127_SHARP_),clojure.string.lower_case.call(null,query));
}),stacks);
});
bookstacks.subs.generate_stacks = (function bookstacks$subs$generate_stacks(books){
return cljs.core.set.call(null,cljs.core.reduce.call(null,(function (p1__29128_SHARP_,p2__29129_SHARP_){
return cljs.core.concat.call(null,p1__29128_SHARP_,cljs.core.keys.call(null,new cljs.core.Keyword(null,"stacks","stacks",-456633410).cljs$core$IFn$_invoke$arity$1(p2__29129_SHARP_)));
...
switch (G__29133) {
case "In Progress":
return ((function (G__29133){
return (function (p1__29130_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"reading","reading",-409289668),new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(p1__29130_SHARP_));
});
;})(G__29133))
...
return cljs.core.some.call(null,((function (G__29133){
return (function (p1__29131_SHARP_){
return cljs.core._EQ_.call(null,p1__29131_SHARP_,stack);
});})(G__29133))
...
return cljs.core.map.call(null,(function (p1__29135_SHARP_){
return cljs.core.assoc.call(null,p1__29135_SHARP_,new cljs.core.Keyword(null,"index","index",-1531685915),cljs.core.get.call(null,new cljs.core.Keyword(null,"stacks","stacks",-456633410).cljs$core$IFn$_invoke$arity$1(p1__29135_SHARP_),stack));
...
re_frame.core.reg_sub.call(null,new cljs.core.Keyword(null,"stack","stack",-793405930),(function (db,p__29136){
var vec__29137 = p__29136;
var query = cljs.core.nth.call(null,vec__29137,(0),null);
var stack_name = cljs.core.nth.call(null,vec__29137,(1),null);
var books = reagent.ratom.make_reaction.call(null,((function (vec__29137,query,stack_name){
return (function (){
return new cljs.core.Keyword(null,"books","books",-2005362272).cljs$core$IFn$_invoke$arity$1(db);
});})(vec__29137,query,stack_name))
);
...
//# sourceMappingURL=subs.js.map?rel=1476908239813