...
return cljs.core.reset_BANG_.call(null,add_new_title,p1__27313_SHARP_);
});})(add_new_open,add_new_title,add_new_list))
...
return cljs.core.reset_BANG_.call(null,add_new_list,p1__27314_SHARP_);
});})(add_new_open,add_new_title,add_new_list))
...
return new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.input_text,new cljs.core.Keyword(null,"model","model",331153215),search_term,new cljs.core.Keyword(null,"change-on-blur?","change-on-blur?",854283925),false,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Search Stacks & Books",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__27315_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"update-search-term","update-search-term",-1725569553),p1__27315_SHARP_], null));
})], null);
});
...
cljs.core.reset_BANG_.call(null,status__$1,p1__27316_SHARP_);

return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"update-read-status","update-read-status",-1675555937),p1__27316_SHARP_,book], null));
});})(tabs,read_status_open,status__$1))
], null)], null)], null);
});
...
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"update-bookstack-name","update-bookstack-name",1046186781),stack,p1__27320_SHARP_], null));
...
//# sourceMappingURL=views.js.map?rel=1495671818145