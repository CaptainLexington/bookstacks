...
return cljs.core.reset_BANG_.call(null,add_new_title,p1__25802_SHARP_);
});})(add_new_open,add_new_title,add_new_list))
...
return cljs.core.reset_BANG_.call(null,add_new_list,p1__25803_SHARP_);
});})(add_new_open,add_new_title,add_new_list))
...
cljs.core.reset_BANG_.call(null,status__$1,p1__25804_SHARP_);

return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"update-read-status","update-read-status",-1675555937),p1__25804_SHARP_,book,list], null));
});})(tabs,status__$1))
], null);
});
bookstacks.views.bookstack_tabs = (function bookstacks$views$bookstack_tabs(stacks,current_stack){
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.horizontal_tabs,new cljs.core.Keyword(null,"tabs","tabs",-779855354),reagent.ratom.make_reaction.call(null,(function (){
return cljs.core.mapv.call(null,(function (p1__25805_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"label","label",1718410804)],[p1__25805_SHARP_,p1__25805_SHARP_]);
}),cljs.core.deref.call(null,stacks));
})),new cljs.core.Keyword(null,"model","model",331153215),current_stack,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__25806_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"select-stack","select-stack",-919506772),p1__25806_SHARP_], null));
})], null);
});
bookstacks.views.bookstack = (function bookstacks$views$bookstack(stack){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.booklist","div.booklist",-175161908),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3","h3",2067611163),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(stack)], null),cljs.core.into.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul","ul",-1349521403)], null),cljs.core.map.call(null,(function (p1__25807_SHARP_){
return (new cljs.core.PersistentVector(null,3,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.keyword.call(null,[cljs.core.str("li."),cljs.core.str(cljs.core.name.call(null,new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(p1__25807_SHARP_)))].join('')),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(p1__25807_SHARP_)], null),bookstacks.views.read_status.call(null,new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(p1__25807_SHARP_),p1__25807_SHARP_,stack)],null));
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.v_box,new cljs.core.Keyword(null,"gap","gap",80255254),"1em",new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [bookstacks.views.home_title], null),bookstacks.views.bookstack_tabs.call(null,stacks,current_stack),bookstacks.views.add_a_list.call(null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),bookstacks.views.bookstack.call(null,cljs.core.deref.call(null,stack))], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [bookstacks.views.link_to_about_page], null)], null)], null);
});
...
//# sourceMappingURL=views.js.map?rel=1474405720668