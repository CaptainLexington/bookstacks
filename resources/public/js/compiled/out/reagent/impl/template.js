...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__23184__auto__,writer__23185__auto__,opt__23186__auto__){
return cljs.core._write.call(null,writer__23185__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__24211 = o;
(G__24211[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__22566__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__22566__auto__){
var and__22566__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__22566__auto____$1){
var and__22566__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__24219 = jsprops;
(G__24219["defaultValue"] = value);

(G__24219["onChange"] = ((function (G__24219,v,value,on_change){
return (function (p1__24217_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__24217_SHARP_);
});})(G__24219,v,value,on_change))
);
...
var vec__24226 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__24226,(0),null);
var id = cljs.core.nth.call(null,vec__24226,(1),null);
var class$ = cljs.core.nth.call(null,vec__24226,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___24231 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___24231 == null)){
} else {
var key_24232 = temp__4661__auto___24231;
(jsprops["key"] = key_24232);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__24234 = (new reagent.impl.template.NativeWrapper());
(G__24234["name"] = c);
...
var len__23653__auto___24240 = arguments.length;
var i__23654__auto___24241 = (0);
while(true){
if((i__23654__auto___24241 < len__23653__auto___24240)){
args__23660__auto__.push((arguments[i__23654__auto___24241]));

var G__24242 = (i__23654__auto___24241 + (1));
i__23654__auto___24241 = G__24242;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__23661__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq24238){
var G__24239 = cljs.core.first.call(null,seq24238);
var seq24238__$1 = cljs.core.next.call(null,seq24238);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__24239,seq24238__$1);
});
...
var n__23493__auto___24249 = a.length;
var i_24250 = (0);
while(true){
if((i_24250 < n__23493__auto___24249)){
(a[i_24250] = reagent.impl.template.as_element.call(null,(a[i_24250])));
...
var a = cljs.core.into_array.call(null,s);
var n__23493__auto___24252 = a.length;
var i_24253 = (0);
while(true){
if((i_24253 < n__23493__auto___24252)){
var val_24254 = (a[i_24253]);
if((cljs.core.vector_QMARK_.call(null,val_24254)) && ((reagent.impl.template.key_from_vec.call(null,val_24254) == null))){
(o["no-key"] = true);
} else {
}

(a[i_24253] = reagent.impl.template.as_element.call(null,val_24254));

var G__24255 = (i_24253 + (1));
i_24253 = G__24255;
continue;
} else {
}
...
var ctx = {};
var vec__24259 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__24259,(0),null);
var derefed = cljs.core.nth.call(null,vec__24259,(1),null);
...
var G__24263 = (cljs.core.count.call(null,argv) - first_child);
switch (G__24263) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__24263){
...
//# sourceMappingURL=template.js.map?rel=1474484602914