...
var and__25564__auto__ = goog.labs.userAgent.browser.isChrome();
...
devtools.custom_formatters.CLJSDevtoolsFormatter.cljs$lang$ctorPrWriter = (function (this__26182__auto__,writer__26183__auto__,opt__26184__auto__){
return cljs.core._write.call(null,writer__26183__auto__,"devtools.custom-formatters/CLJSDevtoolsFormatter");
});
...
var len__26651__auto___29180 = arguments.length;
var i__26652__auto___29181 = (0);
while(true){
if((i__26652__auto___29181 < len__26651__auto___29180)){
args__26658__auto__.push((arguments[i__26652__auto___29181]));

var G__29182 = (i__26652__auto___29181 + (1));
i__26652__auto___29181 = G__29182;
continue;
} else {
}
break;
...
return devtools.custom_formatters.log_exception_if_avail.cljs$core$IFn$_invoke$arity$variadic(argseq__26659__auto__);
});
...
devtools.custom_formatters.log_exception_if_avail.cljs$lang$applyTo = (function (seq29179){
return devtools.custom_formatters.log_exception_if_avail.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq29179));
});

devtools.custom_formatters.monitor_api_calls = (function devtools$custom_formatters$monitor_api_calls(name,api_call){
return (function() { 
var G__29183__delegate = function (args){
...
while (G__29184__i < G__29184__a.length) {G__29184__a[G__29184__i] = arguments[G__29184__i + 0]; ++G__29184__i;}
  args = new cljs.core.IndexedSeq(G__29184__a,0);
} 
return G__29183__delegate.call(this,args);};
G__29183.cljs$lang$maxFixedArity = 0;
G__29183.cljs$lang$applyTo = (function (arglist__29185){
var args = cljs.core.seq(arglist__29185);
return G__29183__delegate(args);
});
...
return (function() { 
var G__29188__delegate = function (args){
...
while (G__29189__i < G__29189__a.length) {G__29189__a[G__29189__i] = arguments[G__29189__i + 0]; ++G__29189__i;}
  args = new cljs.core.IndexedSeq(G__29189__a,0);
} 
return G__29188__delegate.call(this,args);};
...
return G__29188__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__25564__auto__ = cljs.core.not.call(null,devtools.custom_formatters._STAR_installed_STAR_);
...
//# sourceMappingURL=custom_formatters.js.map?rel=1480029274431